...
def welcome():
    ...
    return (
        ...
        f"total precipitation by date for all stations: /api/v1.0/precipitation<br/>"
        f"list of stations in the data set: /api/v1.0/stations<br/>"
...
def tobs():
    ...
    results = session.query(Measurement.date,Measurement.tobs).filter(Measurement.date >= one_year_from_recent).\
